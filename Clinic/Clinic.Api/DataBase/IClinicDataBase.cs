...
public interface IClinicDataBase
{
    ...
    IReadOnlyCollection<Specialization> GetAllSpecializations();
    ...
    IReadOnlyCollection<Appointment> GetAppointmentsByDoctor(int Id);
    ...
    IReadOnlyCollection<Appointment> GetAppointmentsByPatient(int Id);

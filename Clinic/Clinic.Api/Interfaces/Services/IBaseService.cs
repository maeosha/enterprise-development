...
/// <typeparam name="TCreateDto">The DTO type for creating new entities.</typeparam>
/// <typeparam name="TUpdateDto">The DTO type for updating existing entities.</typeparam>
public interface IBaseServices<TGetDto, TCreateDto, TUpdateDto>
    where TGetDto : class
    ...
    where TUpdateDto : class
{
    ...
    public TGetDto? Create(TCreateDto createDto);
    ...
    public TGetDto? Update(int id, TUpdateDto updateDto);
